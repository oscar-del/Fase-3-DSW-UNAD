...
function calcMaxWidth(){for (i = 0; i < wordsG.length; i++) {var actualSize=0;actualSize=$.trim(aforWords(wordsG[i])).length*(50+9);
...
function paintbGame(){profG=profG+38+9;var leV=(actMaxWidth-($.trim(aforWords(wordsG[indexG])).length-1)*(38+19))/2;
